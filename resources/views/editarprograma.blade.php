...
@section('content')
    <div class="row d-flex flex-column" style="margin: 0 100px">
        ...
        <form action="{{route('programas.store',$tblPrograma)}}" method="POST">
            @csrf
            @method('PUT')
            <div class="row mb-3">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="prog_Denominacion" class="form-control" placeholder="Programa" value="{{$tblPrograma->prog_Denominacion}}" >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" style="height:100px" name="prog_Descripcion" placeholder="Descripción...">{{$tblPrograma->prog_Descripcion}}</textarea>
                    </div>
